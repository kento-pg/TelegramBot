...
GRAMMAR_EXERCISES = [
    ...
    {"broken": "I had my car repair last week.",
     "correct": "I had my car repaired last week.",
     "explanation": "Causative 'have something done' needs a past participle after the object ('repaired'), not the base form."},
    {"broken": "If I studied harder in college, I would have a better job now.",
     "correct": "If I had studied harder in college, I would have a better job now.",
     "explanation": "Mixed conditional (past condition, present result): past perfect in the if-clause ('had studied'), paired with 'would + base verb' in the result clause."},
    {"broken": "I wish I am taller.",
     "correct": "I wish I were taller.",
     "explanation": "'Wish' about a present unreal state takes the past subjunctive ('were'), not 'am' — even with 'I', it's 'I wish I were'."},
    {"broken": "Please turn off it before you leave.",
     "correct": "Please turn it off before you leave.",
     "explanation": "With separable phrasal verbs, a pronoun object goes between the verb and particle ('turn it off'), not after the particle."},
    {"broken": "She gave me an advice about my career.",
     "correct": "She gave me advice about my career.",
     "explanation": "'Advice' is uncountable, so it can't take 'an' — say 'advice' (or 'some advice'), never 'an advice'."},
    {"broken": "The more you practice, more you improve.",
     "correct": "The more you practice, the more you improve.",
     "explanation": "The parallel comparative structure needs 'the' in both halves: 'the more..., the more...'."},
    {"broken": "I did told you about the deadline yesterday.",
     "correct": "I did tell you about the deadline yesterday.",
     "explanation": "Emphatic 'do/did' is followed by the base verb ('tell') — the past tense is already carried by 'did'."},
    {"broken": "You're coming to the party tonight, isn't it?",
     "correct": "You're coming to the party tonight, aren't you?",
     "explanation": "A question tag must match the subject and auxiliary of the main clause — 'you're' needs 'aren't you', not 'isn't it'."},
    {"broken": "Could you tell me where is the nearest station?",
     "correct": "Could you tell me where the nearest station is?",
     "explanation": "In an indirect question, word order reverts to statement order (subject before verb) — not question order."},
    {"broken": "Swimming in cold water require a lot of courage.",
     "correct": "Swimming in cold water requires a lot of courage.",
     "explanation": "A gerund used as the subject ('Swimming') is treated as singular, so the verb must be 'requires', not 'require'."},
    {"broken": "She is the client who I told you about her.",
     "correct": "She is the client who I told you about.",
     "explanation": "'Who' already refers back to 'the client' — don't repeat it with an extra pronoun ('her') later in the sentence."},
    {"broken": "There were less applicants this year than last year.",
     "correct": "There were fewer applicants this year than last year.",
     "explanation": "'Fewer' is used with countable nouns ('applicants'); 'less' is for uncountable nouns."},
    {"broken": "When I was a kid, I use to walk to school every day.",
     "correct": "When I was a kid, I used to walk to school every day.",
     "explanation": "The habitual-past structure is 'used to' (with -d), not 'use to', regardless of the subject."},
    {"broken": "She's very capable to handle this project alone.",
     "correct": "She's very capable of handling this project alone.",
     "explanation": "The fixed pattern is 'capable of + gerund', not 'capable to + infinitive'."},
    {"broken": "No sooner I had arrived than the phone rang.",
     "correct": "No sooner had I arrived than the phone rang.",
     "explanation": "'No sooner' at the start of a sentence triggers inversion of the auxiliary and subject: 'No sooner had I arrived...'."},
]
...
VOCAB_EXERCISES = [
    ...
    {"question": "What does 'meticulous' mean?",
     "options": {"A": "Careless", "B": "Very careful and precise about details", "C": "Fast", "D": "Confusing"},
     "answer": "B", "example": "The auditor was meticulous in checking every transaction."},
    {"question": "What does 'candid' mean?",
     "options": {"A": "Dishonest", "B": "Honest and straightforward", "C": "Shy", "D": "Overly formal"},
     "answer": "B", "example": "He gave a candid opinion about the proposal."},
    {"question": "What does 'redundant' mean (in a job context)?",
     "options": {"A": "Essential", "B": "No longer needed", "C": "Highly paid", "D": "Popular"},
     "answer": "B", "example": "Several positions became redundant after the merger."},
    {"question": "What does 'to undermine' mean?",
     "options": {"A": "To strengthen", "B": "To weaken gradually, often secretly", "C": "To ignore", "D": "To celebrate"},
     "answer": "B", "example": "Constant criticism undermined her confidence."},
    {"question": "What does 'resilient' mean?",
     "options": {"A": "Fragile", "B": "Able to recover quickly from difficulties", "C": "Stubborn", "D": "Slow"},
     "answer": "B", "example": "The economy proved resilient despite the crisis."},
    {"question": "What does 'to allocate' mean?",
     "options": {"A": "To waste", "B": "To distribute for a specific purpose", "C": "To hide", "D": "To cancel"},
     "answer": "B", "example": "The company allocated more budget to marketing this year."},
    {"question": "What does 'discrepancy' mean?",
     "options": {"A": "Agreement", "B": "A difference between things that should match", "C": "A large amount", "D": "A type of contract"},
     "answer": "B", "example": "There was a discrepancy between the two reports."},
    {"question": "What does 'to mitigate' mean?",
     "options": {"A": "To make worse", "B": "To make less severe", "C": "To ignore", "D": "To celebrate"},
     "answer": "B", "example": "The company took steps to mitigate the financial risk."},
    {"question": "What does 'prudent' mean?",
     "options": {"A": "Careless", "B": "Careful and sensible, especially about money", "C": "Generous", "D": "Impulsive"},
     "answer": "B", "example": "It's prudent to save part of your income every month."},
    {"question": "What does 'to disclose' mean?",
     "options": {"A": "To hide", "B": "To make known or reveal", "C": "To sell", "D": "To exchange"},
     "answer": "B", "example": "The company must disclose any conflicts of interest."},
    {"question": "What does 'viable' mean?",
     "options": {"A": "Impossible", "B": "Capable of working successfully", "C": "Expensive", "D": "Outdated"},
     "answer": "B", "example": "Is this business plan financially viable?"},
    {"question": "What does 'to comply' mean?",
     "options": {"A": "To break rules", "B": "To act in accordance with a rule", "C": "To ignore instructions", "D": "To negotiate"},
     "answer": "B", "example": "All employees must comply with the new safety policy."},
    {"question": "What does 'scrutiny' mean?",
     "options": {"A": "Praise", "B": "Close and critical examination", "C": "A quick glance", "D": "Approval"},
     "answer": "B", "example": "The deal came under intense scrutiny from regulators."},
]
...
TRANSLATE_EXERCISES = [
    ...
    {"indonesian": "Perusahaan itu terpaksa memberhentikan beberapa karyawan karena kondisi ekonomi yang memburuk.",
     "accepted": ["The company was forced to lay off some employees due to worsening economic conditions.",
                  "The company had to let go of several employees because of the declining economy."]},
    {"indonesian": "Meskipun sudah diperingatkan berkali-kali, dia tetap mengulangi kesalahan yang sama.",
     "accepted": ["Even though he had been warned several times, he kept repeating the same mistake.",
                  "Despite being warned multiple times, he still repeated the same mistake."]},
    {"indonesian": "Kalau saja saya tahu jalan ini macet, saya pasti berangkat lebih awal.",
     "accepted": ["If only I had known this road was jammed, I would have left earlier.",
                  "Had I known this road was congested, I would have left earlier."]},
    {"indonesian": "Sebagian besar investor memilih untuk menunggu sampai situasi pasar lebih stabil.",
     "accepted": ["Most investors chose to wait until the market situation became more stable.",
                  "The majority of investors decided to wait until the market was more stable."]},
    {"indonesian": "Dia bersikeras bahwa dirinya tidak bersalah atas kesalahan tersebut.",
     "accepted": ["He insisted that he was not responsible for the mistake.",
                  "He insisted he wasn't at fault for the error."]},
    {"indonesian": "Semakin cepat kita menyelesaikan proyek ini, semakin cepat kita bisa mulai yang berikutnya.",
     "accepted": ["The faster we finish this project, the sooner we can start the next one.",
                  "The sooner we complete this project, the quicker we can begin the next one."]},
    {"indonesian": "Saya tidak yakin apakah keputusan ini akan menguntungkan dalam jangka panjang.",
     "accepted": ["I'm not sure whether this decision will be profitable in the long run.",
                  "I'm not certain if this decision will pay off in the long term."]},
    {"indonesian": "Banyak perusahaan rintisan gagal karena kehabisan modal sebelum mencapai keuntungan.",
     "accepted": ["Many startups fail because they run out of capital before becoming profitable.",
                  "A lot of startups fail because they run out of funding before turning a profit."]},
    {"indonesian": "Tolong pastikan semua dokumen sudah ditandatangani sebelum rapat dimulai.",
     "accepted": ["Please make sure all the documents have been signed before the meeting starts.",
                  "Please ensure that all documents are signed before the meeting begins."]},
    {"indonesian": "Dia menyesal tidak berinvestasi lebih awal ketika harganya masih rendah.",
     "accepted": ["He regretted not investing earlier when the price was still low.",
                  "He regrets not having invested sooner while the price was low."]},
]
